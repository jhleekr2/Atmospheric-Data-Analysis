...
for month in range(1,13):
    ...
    file_pattern = f'derived-era5-pressure-levels-daily-statistics_500_*{month_str}.nc'
    output_file_path = f'derived-era5-pressure-levels-daily_500_{month_str}_mean.nc'
    variable_name = 'z'
