...
for month in range(1,13):
    ...
    file_pattern = f'specific_humidity_stream-oper_daily-mean_*{month_str}.nc'
    output_file_path = f'specific_humidity_stream-oper_daily-mean_850_{month_str}_mean.nc'
    variable_name = 'q'
